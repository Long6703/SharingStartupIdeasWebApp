    ...
    public partial class SSIV2Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__category__72E12F1BE6A84FDF")
                    .IsUnique();
            ...
            modelBuilder.Entity<IdeaInterest>(entity =>
            {
                entity.HasKey(e => e.InterestId)
                    .HasName("PK__idea_int__0F5A1FAD12D44E44");
            ...
            modelBuilder.Entity<InvestmentRequest>(entity =>
            {
                entity.HasKey(e => e.RequestId)
                    .HasName("PK__investme__18D3B90F8B85B3DD");
            ...
            modelBuilder.Entity<Transaction>(entity =>
            {
                ...
                entity.HasIndex(e => e.TransactionCode, "UQ__transact__DD5740BEBE4D5723")
                    .IsUnique();
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__user__AB6E6164A3B3F6B3")
                    .IsUnique();
